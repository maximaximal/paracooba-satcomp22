...
\author{\IEEEauthorblockN{1\textsuperscript{st} Maximilian Levi Heisinger}
...
\and
\IEEEauthorblockN{2\textsuperscript{nd} Mathias Fleury}
\IEEEauthorblockA{\textit{Chair of Computer Architecture} \\
\textit{University of Freiburg}\\
Freiburg, Germany \\
fleury@cs.uni-freiburg.de}
\and
\IEEEauthorblockN{3\textsuperscript{rd} Armin Biere}
\IEEEauthorblockA{\textit{Chair of Computer Architecture} \\
\textit{University of Freiburg}\\
Freiburg, Germany \\
...
Framework, 2021}
Plingeling and Treengeling Entering the SAT Competition 2020, SAT 2020}
\end{thebibliography}
